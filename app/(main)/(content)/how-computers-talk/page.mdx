import { DNSVisual, DNSScrollVisual } from "./_components/dns";
...
Try entering `142.250.73.110` into your browser's address bar. You'll end up on Google's home page!
...
<ScrollGroup figure={<DNSScrollVisual />}>
